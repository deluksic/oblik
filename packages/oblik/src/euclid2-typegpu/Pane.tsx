...
import type { Euclid2TypegpuScene } from "../eval/scene";
...
import { Palette } from "../euclid2/Palette";
...
import { TypegpuView } from "./TypegpuView";

import { status as statusLine, statusError, workspace, wrap } from "../ui/pane.module.css";

export type Euclid2TypegpuPaneProps = {
  scene: Euclid2TypegpuScene;
  file: string;
...
export function Euclid2TypegpuPane(props: Euclid2TypegpuPaneProps) {
