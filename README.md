...
- [?scene=gear](http://127.0.0.1:43117/?scene=gear) — **involute spur pair.** Drag the pinion centre and pitch radius (module follows). Tooth counts, pressure angle, and mesh rotation are titled sliders. The wheel is derived: same module, centre distance `(z1+z2)·m/2`, opposite rotation so a tooth meets a space. Flanks are involute polylines; addendum and root are true arcs.
