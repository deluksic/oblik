...
- [?scene=rose](http://127.0.0.1:43117/?scene=rose) — **cylinder CSG, plan + SDF.** Fixed outer radius. Drag the ring the six balls sit on, and the centre ball Ø; height is the 3D glider. Spheres sit on the top face.
