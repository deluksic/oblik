...
- [?scene=rose](http://127.0.0.1:43117/?scene=rose) — **cylinder CSG, plan + SDF.** Seven cylinders hex-packed (fixed 6 around 1). Each top is a quatrefoil (4 around 1). Drag the centre cell’s ring, centre Ø, and foil Ø; height is the 3D glider.
