...
- [?scene=rose](http://127.0.0.1:43117/?scene=rose) — **joined rings, filled disks, then quatrefoil cuts.** Three panes: packed plan (`cylinder.ts`), sweep profile (`profile.ts`, X radial / Y is Z), SDF field. Cylinders fill the inside of the seven rims; spheres cut after that union. Height is the 3D glider.
