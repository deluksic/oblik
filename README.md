...
- Click a tick: inspector shows **kind or const name**, **origin** (which helper built it), and **style** stored on the constructor (`{ style }` in the scene file; revert to the view default).
