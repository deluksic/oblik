...
- [?scene=rose](http://127.0.0.1:43117/?scene=rose) — **cylinder CSG.** Three panes: packed plan (`cylinder.ts`), sweep profile (`profile.ts`, X radial / Y is Z), SDF field. Height is the 3D glider.
