...
- [?scene=rose](http://127.0.0.1:43117/?scene=rose) — **cylinder CSG, plan + SDF.** Fixed outer radius. Drag the six-ball ring, centre Ø, and outer ball Ø; height is the 3D glider (no minimum). Spheres sit on the top face.
