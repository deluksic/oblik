...
- [?scene=rose](http://127.0.0.1:43117/?scene=rose) — **SDF CSG.** A cylinder minus seven spheres whose centres sit on the barrel. No provenance or pick on the field; coral handles write `rose-sdf.ts`.
