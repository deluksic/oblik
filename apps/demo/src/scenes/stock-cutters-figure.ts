...
export default defineScene({
  ...
  hint: "paint(face) is the CSG formula. Dashed midline is split — a construction guide for left/right, not stock or a cutter.",
  ...
  build() {
    ...
    paint(cut.midline, { stroke: "#1c1917", width: 1.05, dash: [5, 3.5] }, "o_sc_psplit");
  },
});
